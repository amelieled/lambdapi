...
(** [to_string ?print_fname pos] transforms the position [pos] into a readable
    string. If [print_fname] is [true] (the default), the filename contained
    in [pos] is printed. *)
...
(** [print_short oc pos] prints the optional position [pos] to channel [oc]
